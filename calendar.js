...
(function () {
  ...
  var EVENTS = [
    ...
    { d: [14, 35], cat: 'med', t: '영유아 건강검진 1차 창 ⚠️', s: '창이 3주뿐. 지나면 해당 회차 무료 혜택 소멸. 소아과 첫 방문 겸', href: 'part3.html#c' },
    { d: 28,  cat: 'med', t: 'BCG 접종 마감 (4주 이내)', s: '피내용은 지정기관 예약 필요', href: 'part3.html#a' },
    { d: 30,  cat: 'med', t: 'B형간염 2차 (1개월)', s: '', href: 'part3.html#a' },
    { d: [42, 105], cat: 'med', t: '로타바이러스 1차 시작 창 ⚠️', s: '생후 6주~15주 0일. 놓치면 아예 못 맞음', href: 'part3.html#a' },
    ...
    { d: [28, 84], cat: 'mom', t: '임신성 당뇨였다면 후속 당부하검사 창 (4~12주)', s: '가장 많이 누락되는 항목', href: 'part4.html#d' },
